...
const ani = (0, _gsap.gsap).to('.box', {
    duration: 2,
    x: 300
}); //now we can perfom different types of animations to this variable
//Timeline in js: A Timeline is a container for animations performing multiple animations in sequence
const boxTimeline = (0, _gsap.gsap).timeline();
boxTimeline.to('.one-box', {
    duration: 1,
    x: 100
}).to('.two-box', {
    duration: 1,
...
},{"gsap":"9F7Z6"}],"9F7Z6":[function(require,module,exports,__globalThis) {
...
},{"./gsap-core.js":"evdHe","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["n0fw4","kTBnD"], "kTBnD", "parcelRequireaee6", {})

//# sourceMappingURL=Learning GSAP.3c14d121.js.map
